...
return [
    ...
    'types' => [
        '0' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, description, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ...
    'columns' => [
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:mb_teasers/Resources/Private/Language/locallang_db.xlf:tx_mbteasers_domain_model_accordianteaser.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'description' => [
            'exclude' => true,
            'label' => 'LLL:EXT:mb_teasers/Resources/Private/Language/locallang_db.xlf:tx_mbteasers_domain_model_accordianteaser.description',
            'config' => [
                'type' => 'text',
                'enableRichtext' => true,
                // 'size' => 30,
